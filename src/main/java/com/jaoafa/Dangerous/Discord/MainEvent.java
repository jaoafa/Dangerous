...
public class MainEvent {
	...
	public void onMessageReceivedEvent(MessageReceivedEvent event) {
		...
		try {
            ...
            Class.forName("com.jaoafa.Dangerous.Discord.Cmd_" + className);
            // クラスがない場合これ以降進まない
            Constructor<?> construct = (Constructor<?>) Class.forName("com.jaoafa.Dangerous.Discord.Cmd_" + className).getConstructor();
